...
public class LoginControllerTest {
    ...
    @Test
void testRealValidUserPath() {
    LoginController real = new LoginController();
    // Agar actual isValidUser() method ke andar koi logic hai, ye usko hit karega
    String result = real.login("admin", "1234");
    assertEquals("Login Success", result);
}

@Test
void testRealInvalidUserPath() {
    LoginController real = new LoginController();
    String result = real.login("user", "wrong");
